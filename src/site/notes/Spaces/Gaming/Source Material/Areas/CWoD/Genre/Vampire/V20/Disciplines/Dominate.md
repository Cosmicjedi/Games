...
[[Spaces/Gaming/Source Material/Areas/CWoD/Genre/Vampire/V20/Rules/Eye Contact|Eye Contact]]
...
### System: 
The player rolls **Manipulation + Leadership** (*difficulty equal to the target’s current Willpower points*). The number of successes determines how well the suggestion takes hold in the victim’s subconscious. 

* If the vampire scores one or two successes, the subject cannot be forced to do anything that seems strange to her (she might walk outside, but is unlikely to steal a car). 
